...
//         time[4] = nol(second);
//     }
//     if ((Number(time[2])<3) && (Number(time[2])>8)){
//         currentTimeHtml ="<img class='boardsign' src='https://img.shields.io/badge/奶茶店-营业中-6adea8?style=social&logo=bitbucket' title='努力进步中~'><div id='runtime'>" + time[0] + ' YEAR ' + time[1] + ' DAYS ' + time[2] + ' : ' + time[3] + ' : ' + time[4] + '</div>';
//     }
//     else{
//         currentTimeHtml ="<img class='boardsign' src='https://img.shields.io/badge/奶茶店-打烊了-6adea8?style=social&logo=bitbucket' title='这个点了应该去睡觉啦，熬夜对身体不好哦'><div id='runtime'>" + time[0] + ' YEAR ' + time[1] + ' DAYS ' + time[2] + ' : ' + time[3] + ' : ' + time[4] + '</div>';
//     }
